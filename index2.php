		...
		<script type="text/javascript">
            ...
            Ext.onReady(function() {
				...
				function  GridLogs(){
                    ...
                    storeLogs = Ext.create('Ext.data.Store', {
                        extend : 'Ext.data.Store',
                        model : logs,
                        proxy : {
                            type : 'ajax',
                            url : 'consulta_logs.php',
                            reader : {
                                type : 'json',
                                root : 'data',
                            }
                    ...
                    // storeLogs.load();
                     rowEditing2 = Ext.create('Ext.grid.plugin.RowEditing', {
                        clicksToMoveEditor : 2,
                        autoCancel : false
                    });
                     
                      gridLogs = Ext.create('Ext.grid.Panel', {
                        store : storeLogs,
                        height : '100%',
                        width : '100%',
                        columns : [{
                            ...
                            header : 'DATA PACIENTE',
                            dataIndex : 'data_paciente',
                            name : 'data_paciente',
                            flex : 1,
                            editor : {
                                xtype : 'textfield'
                            ...
                            header : 'DADOS HISTORICO',
                            dataIndex : 'dados_historio',
                            name : 'dados_historio',
                            flex : 2,
                            editor : {
                                xtype : 'htmleditor',
                    ...
                    grid = Ext.create('Ext.grid.Panel', {
                        ...
                        listeners : {
                            ...
                            'edit' : function(editor, e) {
                                ...
                                if (grid.columns[5].field.getValue() == null && grid.columns[4].field.getValue() == null) {
                ...
                function janelaLogs(){
                	janelalogs = Ext.create('Ext.window.Window', {
                ...
                function getTab(usuario) {
                    var tab2 = Ext.widget({
                        ...
                        }, getBtnCadastroUsuario(),getBtnLogs()]
                    });
                    return tab2
                }
