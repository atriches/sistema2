...
if ($nbrows > 0) {
	...
	$table = '<table border ="1">
			<tr>
				...
				<td>idusuario</td> 
				<td>idligador</td> 
				<td>identrevistador</td> 
				<td>idpsicologo</td> 
				<td>nome_crianca</td> 
				<td>sexo_crianca</td> 
				<td>data_nascimento_crianca</td> 
				<td>idade_crianca</td> 
				<td>cel_crianca</td> 
				<td>email</td> 
				<td>endereco</td> 
				<td>complemento</td> 
				<td>bairro</td> 
				<td>cidade_crianca</td> 
				<td>estado_crianca</td> 
				<td>escola_crianca</td> 
				<td>responsavel_direto_crianca</td> 
				<td>tipo_responsavel1</td> 
				<td>tipo_contato_resp1</td> 
				<td>tel_residencial_resp1</td> 
				<td>end_resp1</td> 
				<td>intencao_mudanca_resp1</td> 
				<td>novo_endereco_resp1</td> 
				<td>nome_resp1</td> 
				<td>tel_comercial_resp1</td> 
				<td>tel_celular_resp1</td> 
				<td>novo_tel_resp1</td> 
				<td>ocupacao_resp1</td> 
				<td>cep_resp1</td> 
				<td>estado_civil_resp1</td> 
				<td>notas1</td> 
				<td>outro_residencial_resp1</td> 
				<td>outro_comercial_resp1</td> 
				<td>outro_celular_resp1</td> 
				<td>tipo_responsavel2</td> 
				<td>tel_residencial_resp2</td> 
				<td>end_resp2</td> 
				<td>intencao_mudanca_resp2</td> 
				<td>novo_endereco_resp2</td> 
				<td>nome_resp2</td> 
				<td>estado_civil_resp2</td>
 				<td>conhecido_resp2</td> 
 				<td>tipo_contato_resp2</td> 
 				<td>tel_comercial_resp2</td> 
 				<td>tel_celular_resp2</td> 
 				<td>novo_tel_resp2</td> 
 				<td>ocupacao_resp2</td> 
 				<td>cep_resp2</td> 
 				<td>contato1_nome</td> 
 				<td>contato2_nome</td> 
 				<td>contato3_nome</td> 
 				<td>contato4_nome</td> 
 				<td>contato5_nome</td> 
 				<td>contato1_telefone</td> 
 				<td>contato2_telefone</td> 
 				<td>contato3_telefone</td> 
 				<td>contato4_telefone</td> 
 				<td>contato5_telefone</td> 
 				<td>contato1_parentesco</td> 
 				<td>contato2_parentesco</td> 
 				<td>contato3_parentesco</td>
  				<td>contato4_parentesco</td> 
  				<td>contato5_parentesco</td> 
  				<td>anotacoes_entrevistador</td> 
  				<td>status</td> 
  				<td>etapa</td> 
  				<td>qtd_tentativa_ligacoes</td> 
  				<td>qtd_tentativa_entrevista</td> 
  				<td>qtd_tentativa_psi</td> 
  				<td>qtd_recusa_ligacoes</td> 
  				<td>qtd_recusa_entrevista</td> 
  				<td>qtd_recusa_psi</td> 
  				<td>qtd_pergutas_resp30</td> 
  				<td>qtd_pergutas_resp4</td> 
  				<td>parecer_pscologico</td> 
  				<td>exame_realizado</td> 
  				<td>checagem_telefonica</td> 
  				<td>data_ultimo_contato</td> 
  				<td>qtd_nao_atendeu</td> 
	...
	while ($row = mysql_fetch_array($result, MYSQL_ASSOC)) {
		...
		for ($i = 0; $i < count($ar); $i++) {
			...
			$table .= '<td>' . utf8_encode(trim($row[$ar[$i]])) . '</td>';
		}
		$ct++;
